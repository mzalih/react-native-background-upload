...
//        [request setValue:@"Transfer-Encoding" forHTTPHeaderField:@"Chunked"];
...
//
        ...
        if ([uploadType isEqualToString:@"multipart"]) {
            ...
            NSURL *fileUri = [NSURL URLWithString: fileURI];
            uploadTask = [[self urlSession] uploadTaskWithRequest:request fromFile:fileUri];
        } else {
